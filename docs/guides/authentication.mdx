...
$credential.Password | ConvertFrom-SecureString | Out-File "$env:USERPROFILE\.*kagi*_session.cred"

# Use in scripts
$secureString = Get-Content "$env:USERPROFILE\.*kagi*_session.cred" | ConvertTo-SecureString
