...
Prompt Kagi Assistant and continue existing conversation threads from the terminal.
...
- Integrating Assistant replies into scripts
...
- [Workflows](/guides/workflows) - Conversation and automation patterns
